...
server {
  ...
  # Use the certs generated by the snikket's certbox so you have chat+groups+share 
    ssl_certificate /var/lib/docker/volumes/snikket_snikket_data/_data/letsencrypt/live/chat.example.com/fullchain.pem;
    ssl_certificate_key /var/lib/docker/volumes/snikket_snikket_data/_data/letsencrypt/live/chat.example.com/privkey.pem;
